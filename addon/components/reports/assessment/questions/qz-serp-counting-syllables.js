...
export default Ember.Component.extend(QuestionMixin, {
  ...
  classNames: ['reports', 'assessment', 'questions', 'qz-counting-syllables'],
  ...
  didInsertElement() {
    ...
    baseAnswers.forEach((item, answerIndex) => {
      ...
      let userAnswer = component.get('answers')[answerIndex]
        ? JSON.parse(component.get('answers')[answerIndex].value)
        : [];
